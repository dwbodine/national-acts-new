...
LOCAL_IMAGE="nationalactsvip/nationalactswww-new:latest"
ECR_IMAGE="804363746695.dkr.ecr.us-east-1.amazonaws.com/nationalactsvip/nationalactswww-new:latest"
