  ...
  return (
    <header className="artist-header-thumbnail">
      <div className="artist-header-thumbnail__inner">
        <section className="artist-header-thumbnail__hero" aria-labelledby="artist-header-thumbnail-title">
          <div className="artist-header-thumbnail__intro">
            ...
            <div className="artist-header-thumbnail__copy">
              <h1 className="artist-header-thumbnail__title" id="artist-header-thumbnail-title">
                {title}
              </h1>
            </div>
          </div>

          <nav className="artist-header-thumbnail__socials" aria-label={`${title} social links`}>
            {visibleSocialLinks.map((socialLink) => {
              ...
              return (
                ...
                >
                  <Icon aria-hidden="true" className="artist-header-thumbnail__social-icon" />
          ...
          <Link className="artist-header-thumbnail__moments-link" href="/moments">
            <span>Meet and Greet photos</span>
            <FaArrowRight aria-hidden="true" />
          </Link>
        </section>

        <section className="artist-header-thumbnail__included" aria-labelledby="artist-header-thumbnail-included-title">
          <h2 className="artist-header-thumbnail__included-title" id="artist-header-thumbnail-included-title">
            What&apos;s included
          </h2>
